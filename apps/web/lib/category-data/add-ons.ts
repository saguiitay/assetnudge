export default {
  ...
  "recommendations": {
    "title": {
      ...
      "examples": {
        "good": [
          "Starter Assets - Third Person Superman Add-On - Full",
          "Targeting System 3.2",
          "Targeting System 3 Extensions",
          "Animation Event Component",
          "Interactive objects and puzzles - MMORPG KIT ADDON"
        ],
        "bad": [
          "Retro Palette Picker",
          "Analytics Manager - Firebase addon",
          "Camera Previewer"
        ]
      }
    },
    ...
    "keywords": {
      ...
      "secondary": [
        ...
        "middleware invector template",
        "invector template mis",
        "add invector"
      ],
      "tips": [
  ...
  "realExamples": [
    {
      "name": "Starter Assets - Third Person Superman Add-On - Full",
      "publisher": "Forge Horizon",
      "tags": [
        "Flying",
        "heat vision",
        "Third Person Controller",
        "superhero flying pack",
        "Superman",
        "flying controller",
        "flying character pack",
    ...
    {
      "name": "Targeting System 3.2",
      "publisher": "mikael.korpinen@gmail.com",
      "tags": [
        "ECS",
        "edge",
        "filtering",
    ...
    {
      "name": "Targeting System 3 Extensions",
      "publisher": "mikael.korpinen@gmail.com",
      "tags": [
        "Customizable",
        "Target locking",
    ...
    {
      "name": "Retro Horror Template - Puzzle Pack 1",
      "publisher": "RetroGig",
      "tags": [
        "Piano",
        "classic",
    ...
    {
      "name": "Animation Event Component",
      "publisher": "Influency",
      "tags": [
        "2D",
        "Animation",
