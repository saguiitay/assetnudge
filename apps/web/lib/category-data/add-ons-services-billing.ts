export default {
  ...
  "recommendations": {
    "title": {
      ...
      "tips": [
        ...
        "Avoid internal product names alone.",
      ...
      "examples": {
        "good": [
          "UniPay - In App Purchase (IAP) Billing",
          "License Manager Pro",
          "OneSignal SDK",
        ...
        "bad": [
          "License Manager",
          "IAPGUARD - In App Purchase (IAP) Receipt Validation",
          "Game Jolt API"
        ]
      }
    },
    ...
    "images": {
      ...
      "requirements": [
        ...
        "Short demo video of purchase flow."
      ],
      "tips": [
  ...
  "realExamples": [
    {
      "name": "UniPay - In App Purchase (IAP) Billing",
      "publisher": "FLOBUK",
      "tags": [
        "products",
        "subscription",
    ...
    {
      "name": "IAPGUARD - In App Purchase (IAP) Receipt Validation",
      "publisher": "FLOBUK",
      "tags": [
        "Protection",
        "app store",
