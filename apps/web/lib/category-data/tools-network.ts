export default {
    ...
    "title": {
      ...
      "examples": {
        "good": [
          ...
          "SimpleWebRTC",
          "GONet",
          "ObjectNet - Easier Multiplayer System"
        ],
        "bad": [
          "Pony Express Networking",
  ...
  "realExamples": [
    {
      "name": "coherence - Multiplayer Networking",
    ...
    {
      "name": "ObjectNet - Easier Multiplayer System",
