export default {
  ...
  "recommendations": {
    "title": {
      ...
      "tips": [
        ...
        "Avoid vague names—include count or scope.",
      ...
      "examples": {
        "good": [
          "HDRI 8K Fractal Panoramic Skyboxes",
          "HDRI Abstract 8K Panorama Skyboxes",
          "Abstract BG Shader's (Extended)",
          "GothicVania Magic Pack 6",
          "GothicVania Magic Pack 6"
        ],
        "bad": [
          "GothicVania Magic Pack 4",
          "Gothicvania Magic Pack N3",
    ...
    "images": {
      ...
      "requirements": [
        ...
        "Short video or GIF if animated."
      ],
      "tips": [
  ...
  "realExamples": [
    {
      "name": "HDRI 8K Fractal Panoramic Skyboxes",
    ...
    {
      "name": "HDRI Abstract 8K Panorama Skyboxes",
      "publisher": "Matei Ioan Alexandru",
      "tags": [
        "spherical map",
        "Skybox",
    ...
    {
      "name": "Abstract BG Shader's (Extended)",
    ...
    {
      "name": "Animal print texture 2D AI",
      "publisher": "Katrusya_87",
      "tags": [
        "Animals",
        "Abstract",
        "2D",
