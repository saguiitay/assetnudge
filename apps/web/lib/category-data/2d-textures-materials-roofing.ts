export default {
  ...
  "recommendations": {
    "title": {
      "optimalLength": "20–23 characters (3–4 words)",
      "tips": [
        "Lead with the surface and style (e.g., 'Hand-Painted Roof Shingles').",
        "Include resolution if meaningful (2K/4K).",
        "Avoid generic names like 'Texture Pack' alone.",
      ...
      "examples": {
        "good": [
          "Texture Set Vol.51 Hand Painted Roofs",
          "Texture Set Vol.55 Hand Painted Roof",
          "Texture Set Vol.30 Hand Painted Roof",
          "Roof_Material",
          "Stylize Roof Texture"
        ],
        "bad": [
          "Hand Painted Texture Pack - Roof Tiles Vol.01",
          "Roof 1 Texture Tile",
          "Roof 2 Texture Tile"
        ]
      }
    ...
    "description": {
      ...
      "structure": [
        "What’s included and best-fit genres.",
        "Counts, formats, sizes (2K/4K, PNG/TGA).",
        "Tiling notes and PBR maps (albedo/normal/roughness).",
        "Pipelines/versions supported.",
        "Use cases and quickstart."
      ],
      "tips": [
    ...
    "images": {
      ...
      "requirements": [
        "Clean hero showing variety and tiling quality.",
        "Close-ups and in-engine mockups on roofs.",
        "Optional infographic listing counts and maps."
      ],
      "tips": [
  ...
  "realExamples": [
    ...
    {
      "name": "100+ Realistic Roof Textures",
      "publisher": "Game Buffs",
      "tags": [
        "URP",
        "metal",
        "Modern",
    ...
    {
      "name": "Texture Set Vol.51 Hand Painted Roofs",
      "publisher": "LowlyPoly",
      "tags": [],
      "whyItWorks": [
        "Clear, specific title that sets expectations.",
    ...
    {
      "name": "Texture Set Vol.55 Hand Painted Roof",
      "publisher": "LowlyPoly",
      "tags": [],
      "whyItWorks": [
        "Clear, specific title that sets expectations.",
    ...
    {
      "name": "Texture Set Vol.30 Hand Painted Roof",
      "publisher": "LowlyPoly",
      "tags": [],
      "whyItWorks": [
        "Clear, specific title that sets expectations.",
