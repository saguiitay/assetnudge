export default {
  ...
  "recommendations": {
    "title": {
      "optimalLength": "20-29 characters (3-4 words)",
      "tips": [
      ...
      "examples": {
        "good": [
          "Amazing and Fast Sun",
          "Leaves & Drifts Particles Pack",
          "Environment / Weather / Nature VFX pack",
          "Confetti Party Particles URP",
          "Warp Tunnel URP"
        ],
        "bad": [
          "FX Snow",
          "Valko's Ocean System [LWRP]",
          "FX Cartoon Cloud"
        ]
      }
    },
  ...
  "realExamples": [
    ...
    {
      "name": "Leaves & Drifts Particles Pack",
      "publisher": "loloop",
      "tags": [
        "Environments",
        "drift",
    ...
    {
      "name": "Environment / Weather / Nature VFX pack",
    ...
    {
      "name": "Confetti Party Particles URP",
    ...
    {
      "name": "Warp Tunnel URP",
      "publisher": "Dmitry Andreev",
      "tags": [
        "Cube Map Space Animation",
        "Warp Window Electric Arcs",
        "Space Distortion Shader",
        "Intergalactic Travel Effect",
        "Customizable Sci-Fi VFX",
        "Space Travel VFX",
        "Sci-Fi Warp Tunnel",
        "Hyperspace Jump VFX",
        "Dynamic Starfield Effect",
        "Teleportation Gate Effect",
        "Space Compression VFX",
        "Warp Gate Animation"
      ],
      "whyItWorks": [
        "Clear, specific title that sets expectations.",
