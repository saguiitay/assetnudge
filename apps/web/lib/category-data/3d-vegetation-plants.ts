export default {
  ...
  "recommendations": {
    "title": {
      "optimalLength": "20-31 characters (3-4 words)",
      "tips": [
      ...
      "examples": {
        "good": [
          ...
          "24 Realistic Dynamic Plant Pack",
          "Wild Harvest: Herbs",
          "Wild Harvest: Salad Garden",
          "Wild Harvest: Root Vegetables"
        ],
        "bad": [
          "Flora Textures 01",
          "Hand Painted Grass and Plants",
          "Mushroom Cartoon Collection"
        ]
      }
    },
    "description": {
    ...
    "keywords": {
      "primary": [
        ...
        "play color",
        "color customization",
        "grow harvest collect",
        "ready play color",
        "play color customization",
        "customization icons"
      ],
      "secondary": [
        "low poly",
  ...
  "realExamples": [
    {
      "name": "Wild Harvest: Crop & Plant Bundle | RPG Gathering Assets",
      "publisher": "NV3D",
      "tags": [
        "gathering",
        "Interactive",
    ...
    {
      "name": "24 Realistic Dynamic Plant Pack",
      "publisher": "Zmars 3D Studio",
      "tags": [
        "wind plants",
        "3D model",
        "vegetation",
    ...
    {
      "name": "Wild Harvest: Salad Garden",
      "publisher": "NV3D",
      "tags": [
        "survival",
        "Interactive",
    ...
    {
      "name": "Wild Harvest: Root Vegetables",
      "publisher": "NV3D",
      "tags": [
        "harvestable",
        "gathering",
