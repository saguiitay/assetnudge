export default {
  ...
  "recommendations": {
    "title": {
      ...
      "examples": {
        "good": [
          "Skybox AI Generator by Blockade Labs (Subscription)",
          "Skybox AI Generator by Blockade Labs (Subscription)",
          "AI Dev Kit Research Lab",
          "AI Dev Kit Pro",
          "AI Dev Kit Pro"
        ],
        "bad": [
          "Commit Gen",
          "Kindly - Simple image and text generation with AI",
          "Builder Brain"
        ]
      }
    },
  ...
  "realExamples": [
    {
      "name": "Skybox AI Generator by Blockade Labs (Subscription)",
      "publisher": "Blockade Labs",
      "tags": [
        "backgrounds",
        "Skybox",
        "art generator",
    ...
    {
      "name": "AI Interactive Novel - Tool for Novel, Narrative, TRPG, Character Creation",
      "publisher": "DEVDUP",
      "tags": [
        "narrative",
        "llm",
    ...
    {
      "name": "Quin AI Assistant ( Claude 3.7, Grok v3, DeepSeek R1 ) 15+ offline & online",
      "publisher": "Inbora Studio",
      "tags": [
        "Image Generator",
        "GPT NPC System",
        "npc dialogue",
