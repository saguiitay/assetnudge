export default {
  ...
  "recommendations": {
    "title": {
      ...
      "examples": {
        "good": [
          "Pixel Medieval Kingdom",
          "2D Weapons Pack With Skins and Icons",
          "Animal Cube (Ninja Cat Series) - Premium 2D Asset",
          "Animal Cube (Ninja Cat Series) - Premium 2D Asset",
          "Juice 2D Platformer Character Movement"
        ],
        "bad": [
          "BBoxAnnotationTool",
  ...
  "realExamples": [
    ...
    {
      "name": "2D Weapons Pack With Skins and Icons",
      "publisher": "Playxoft Studios",
      "tags": [
        "2D",
        "weapon attachments",
        "UI",
    ...
    {
      "name": "Animal Cube (Ninja Cat Series) - Premium 2D Asset",
      "publisher": "Hisa Games",
      "tags": [
        "box",
        "vector",
        "Character",
    ...
    {
      "name": "Juice 2D Platformer Character Movement",
      "publisher": "Symon Jack",
      "tags": [
        "character movement",
        "2D",
        "Character",
    ...
    {
      "name": "2D Space Shooter Assets",
      "publisher": "RavenmoreArt",
      "tags": [
        "Shmup",
        "arcade",
        "action game",
