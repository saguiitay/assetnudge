export default {
  ...
  "recommendations": {
    "title": {
      "optimalLength": "20-39 characters (3-6 words)",
      "tips": [
      ...
      "examples": {
        "good": [
          "Cozy Casual Bundle Vol. 1 - Game Music Pack - Relaxing, Jazz Acoustic Social",
          "Cozy Casual Music Bundle Vol. 3 - Relaxing, Jazz, Casual, Friendly, Chill, VGM",
          "Sakura Falling Mirage Game Music",
          "Ancient Egypt Music Pack",
          "Ancient Egypt Music Pack"
        ],
        "bad": [
          "HANGAR IX: Ethnic World (Interface Events SFX)",
          "Dramatic Music [d220711]",
          "Beyond The Veil"
        ]
      }
    },
  ...
  "realExamples": [
    {
      "name": "Cozy Casual Bundle Vol. 1 - Game Music Pack - Relaxing, Jazz Acoustic Social",
      "publisher": "Lufus",
      "tags": [
        "Piano",
        "Cute",
    ...
    {
      "name": "Cozy Casual Music Bundle Vol. 3 - Relaxing, Jazz, Casual, Friendly, Chill, VGM",
      "publisher": "Lufus",
      "tags": [
        "Cute",
        "cozy",
        "music",
        "Cozy Casual Bundle Vol. 3",
        "VGM",
        "hypercasual",
        "bgm",
        "jazzy",
    ...
    {
      "name": "Sakura Falling Mirage Game Music",
      "publisher": "SOUND AIRYLUVS",
      "tags": [
        "orchestral music",
        "ISAo",
        "vocal",
    ...
    {
      "name": "Medieval Tavern Inn Music",
      "publisher": "BLACKMID",
      "tags": [
        "soundtrack",
        "inn music",
    ...
    {
      "name": "Fantasy Medieval Folk Music",
      "publisher": "BLACKMID",
      "tags": [
        "soundtrack",
        "music",
