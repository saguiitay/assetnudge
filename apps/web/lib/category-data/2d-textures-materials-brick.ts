export default {
  ...
  "realExamples": [
    {
      "name": "CuttedTilesHDRP",
      "publisher": "3dvirtualand",
      "tags": [
        "pbr textures",
        "hdrp materials",
        "Brick",
    ...
    {
      "name": "P3D: Outdoor Wall Tile Texture Pack (LR)",
    ...
    {
      "name": "100+ Realistic Brick Textures",
    ...
    {
      "name": "Terracotta / Brick Materials",
    ...
    {
      "name": "Bricks Vol.143 - Stylized Textures",
      "publisher": "LowlyPoly",
      "tags": [
        "excavations",
        "bricks",
