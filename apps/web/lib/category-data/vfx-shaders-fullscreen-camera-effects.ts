export default {
  ...
  "recommendations": {
    "title": {
      ...
      "tips": [
        "Lead with the technique and pipeline (e.g., 'URP Ambient Occlusion').",
        "State a concrete benefit like 'contact shadows' or 'mobile-friendly'.",
        "Avoid vague branding; be explicit about the effect.",
    ...
    "description": {
      ...
      "structure": [
        ...
        "Compatibility (URP/HDRP/Built-in) and Unity versions.",
        "Setup steps and example presets/scenes.",
    ...
    "images": {
      ...
      "requirements": [
        ...
        "Inspector and setup screenshots.",
        "Short video/GIF sweep over different scenes."
      ],
      "tips": [
  ...
  "realExamples": [
    ...
    {
      "name": "HTrace: Ambient Occlusion HDRP",
      "publisher": "IPGames",
      "tags": [
        "HBAO",
        "ambient occlusion",
    ...
    {
      "name": "MK ChromaFlow - Gradient Shaders",
    ...
    {
      "name": "Umbra Soft Shadows - Better Directional & Contact Shadows for URP",
      "publisher": "Kronnect",
      "tags": [
        "soft shadows",
        "realism",
    ...
    {
      "name": "VolFx - VFX Toolkit (Post Processing, Timeline Tracks, Shaders, Tools)",
      "publisher": "NullTale",
      "tags": [
        "URP",
        "juice",
