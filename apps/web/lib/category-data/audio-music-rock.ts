export default {
  ...
  "recommendations": {
    "title": {
      ...
      "tips": [
        "Name the genre and use case (e.g., 'Modular Gothic Metal Score').",
        "Indicate bundle/track count if space allows.",
        "Avoid abstract titles that hide the vibe.",
      ...
      "examples": {
        "good": [
          "Horror Shooter Music Pack: Sinforged (Modular)",
          "Game Metal Bundle 6",
          "Game Metal Bundle 1",
          "Indie_Rock_Bundle_1",
          "Oldschool Metal Bundle"
        ],
        "bad": [
          "Morpheo fell asleep",
          "Spy Music",
    ...
    "description": {
      ...
      "structure": [
        "Mood and best-fit scenes (1-2 sentences).",
        "What's included (track/stem counts, loopable, formats).",
        "Licensing notes and edit variations.",
        "Integration tips (import, volume, mixing).",
        "Support/updates."
      ],
      "tips": [
    ...
    "images": {
      ...
      "requirements": [
        "Cover art that conveys genre.",
        "Waveform or DAW screenshot optional.",
        "Short video/audio sampler strongly encouraged."
      ],
      "tips": [
  ...
  "realExamples": [
    {
      "name": "Horror Shooter Music Pack: Sinforged (Modular)",
