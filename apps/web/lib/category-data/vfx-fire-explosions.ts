export default {
  ...
  "recommendations": {
    "title": {
      ...
      "tips": [
        "Name the effect type and style (e.g., 'Stylized Fire Explosions').",
      ...
      "examples": {
        "good": [
          ...
          "Blast And Shots Pack",
          "VFX - Fire and Explosions",
          "UNI VFX: Realistic Explosions, Fire & Smoke for Visual Effect Graph",
          "Realistic 6D Lighting Explosions Pack"
        ],
        "bad": [
          "FX Fire",
          "LI_Explosion Particle",
          "LI_Fire Particle"
        ]
      }
    },
  ...
  "realExamples": [
    {
      "name": "Fire & Smoke - Dynamic Nature",
    ...
    {
      "name": "Blast And Shots Pack",
      "publisher": "Dmitry Andreev",
      "tags": [
        "destruction system",
        "Explosion",
        "shot",
    ...
    {
      "name": "VFX - Fire and Explosions",
      "publisher": "Cartoon VFX by Wallcoeur",
      "tags": [
        "Explosion",
        "burning",
        "Fire",
    ...
    {
      "name": "UNI VFX: Realistic Explosions, Fire & Smoke for Visual Effect Graph",
    ...
    {
      "name": "Realistic 6D Lighting Explosions Pack",
      "publisher": "DAVFX",
      "tags": [
        "Explosion",
        "Effects",
