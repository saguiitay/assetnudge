export default {
  ...
  "recommendations": {
    "title": {
      ...
      "tips": [
        "Name the effect/type and style (e.g., 'Volumetric Light Beams').",
        "Mention target pipeline (URP/HDRP/Built-in) when relevant.",
        "Hint at customization or performance if it’s a key benefit.",
      ...
      "examples": {
        "good": [
          ...
          "Egyptian Spells VFX Pack",
          "Realistic Paladin / Holy Magic",
          "Elemental Shockwaves VFX Pack",
          "Realistic ARPG VFX Starter Pack - Lightning Spells"
        ],
        "bad": [
          "10 Particle Pack",
          "10 Particle Pack",
          "10 Fantasy Particle Pack"
        ]
      }
    },
    "description": {
      ...
      "structure": [
        "One-sentence promise of the effect and typical use cases.",
        "Key features (variants, controls, performance notes).",
        "Compatibility (pipelines, platforms, Unity versions).",
        "What’s included (counts, demos, prefabs).",
        "Setup steps or integration notes."
      ],
      "tips": [
    ...
    "images": {
      "optimalCount": "7–11 images",
      "requirements": [
        "Hero on light/dark backgrounds to show readability.",
        "Variation shots (colors/intensity) and in-engine demos.",
        "Short video preview strongly recommended."
      ],
      "tips": [
  ...
  "realExamples": [
    {
      "name": "Prismatic & Rainbow Magic Stylized VFX Starter Kit",
      ...
      "whyItWorks": [
        ...
        "Includes a video or audio preview for quick evaluation."
      ],
      "metrics": {
        "titleLength": 50,
    ...
    {
      "name": "Realistic Paladin / Holy Magic",
      "publisher": "Piloto Studio",
      "tags": [
        "flash",
        "Fantasy",
    ...
    {
      "name": "Elemental Shockwaves VFX Pack",
      "publisher": "Piloto Studio",
      "tags": [
        "moba",
        "AOE",
    ...
    {
      "name": "Realistic ARPG VFX Starter Pack - Lightning Spells",
      "publisher": "Piloto Studio",
      "tags": [
        "Magic",
        "Fantasy",
  ...
  "commonMistakes": [
    ...
    },
    {
      ...
      "impact": "Signals poor maintenance and may break on newer Unity versions/pipelines.",
      "solution": "Ship a small update (URP/HDRP notes, demo scene refresh) and highlight the new support in the changelog."
    },
    {
      "mistake": "Overpriced vs. perceived scope",
      "impact": "Shoppers compare quickly and skip assets that feel expensive for what they get.",
      "solution": "Align price with scope; add bundles or tiers and clarify value (counts, support, performance)."
    },
    {
      "mistake": "Underpricing that undermines quality",
      "impact": "Very low prices can imply low quality and reduce trust.",
      "solution": "Price fairly for the content and include a free lite sample instead of discounting the main pack."
    }
  ]
}