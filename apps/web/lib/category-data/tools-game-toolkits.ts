export default {
  ...
  "recommendations": {
    "title": {
      ...
      "examples": {
        "good": [
          "OpenWorlds VR for Third Person with Game Creator Support",
          "House Crafter V1.0- Modular Building Designer",
          "MAGES SDK - Create Cutting-Edge Medical XR Simulations",
          "Developer Essentials | Everything a developer needs | v2025",
          "Simple Garage System For Realistic Car Controller Pro"
        ],
        "bad": [
          "Sprite Compactor",
          "Buff Master Status Effects",
          "Buff Master Status Effects"
        ]
      }
    },
  ...
  "realExamples": [
    {
      "name": "OpenWorlds VR for Third Person with Game Creator Support",
    ...
    {
      "name": "House Crafter V1.0- Modular Building Designer",
      "publisher": "Ayuo Dev",
      "tags": [
        "house generator",
        "construction",
    ...
    {
      "name": "MAGES SDK - Create Cutting-Edge Medical XR Simulations",
      "publisher": "ORamaVR",
      "tags": [
        "VR Training",
        "Multiplayer",
    ...
    {
      "name": "Developer Essentials | Everything a developer needs | v2025",
    ...
    {
      "name": "Simple Garage System For Realistic Car Controller Pro",
