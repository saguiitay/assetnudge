export default {
  ...
  "recommendations": {
    "title": {
      ...
      "examples": {
        "good": [
          "Advanced Jigsaw Puzzle Game Template - Complete System",
          "Signalia Pro: UI System & Engine",
          "Narrator Event System - Interactive Audio & Dialogue Tool for Unity",
          "Mobile Controller Framework",
          "Turret Controller Template"
        ],
        "bad": [
          "Menger Sponge Puzzle",
          "Go Game with AI",
          "Go Game with AI"
        ]
      }
  ...
  "realExamples": [
    {
      "name": "Advanced Jigsaw Puzzle Game Template - Complete System",
      "publisher": "InstaCare Inc.",
      "tags": [
        "puzzle game",
        "Puzzles",
        "complete template",
    ...
    {
      "name": "Signalia Pro: UI System & Engine",
    ...
    {
      "name": "Narrator Event System - Interactive Audio & Dialogue Tool for Unity",
    ...
    {
      "name": "Mobile Controller Framework",
      "publisher": "nappin",
      "tags": [
        "Analog",
        "mobile controls",
    ...
    {
      "name": "Turret Controller Template",
      "publisher": "Murmillo Interactive",
      "tags": [
        "keyboard",
        "turret",
        "Shooter",
