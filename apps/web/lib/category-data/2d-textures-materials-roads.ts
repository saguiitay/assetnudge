export default {
  ...
  "recommendations": {
    "title": {
      ...
      "tips": [
        "Lead with surface and pipeline (e.g., 'PBR Asphalt & Pavement – URP/HDRP').",
        "Mention resolution and tiling quality (2K/4K, seamless).",
        "Include use-case hints: decals, MicroVerse, EasyRoads.",
      ...
      "examples": {
        "good": [
          ...
          "Road Decal Pack 01",
          "Road Decal Pack 01",
          "Texture Set Vol.59 Hand Painted Road",
          "Asphalt Materials V01"
        ],
        "bad": [
          "Road Terrain Texture Pack",
          "Road Texture Pack",
          "Concrete Asphalt 02"
        ]
      }
    ...
    "description": {
      ...
      "structure": [
        "What it is and best-fit scenes (city, highway, offroad).",
        "What’s included (counts, resolutions, PBR maps).",
        "Compatibility (URP/HDRP/Built-in, terrain/decals).",
        "Performance/tiling notes and usage tips.",
        "Support and updates."
      ],
      "tips": [
    ...
    "images": {
      ...
      "requirements": [
        "Clean hero comparing materials on lit/unlit.",
        "Close-ups of cracks/roughness and normal detail.",
        "In-engine shots on roads/sidewalks and decals.",
  ...
  "realExamples": [
    {
      "name": "Road Textures for MicroVerse Roads",
      "publisher": "Rowlan",
      "tags": [
        "scan",
        "Building",
    ...
    {
      "name": "90+ Realistic Asphalt Textures",
    ...
    {
      "name": "Texture Set Vol.59 Hand Painted Road",
      "publisher": "LowlyPoly",
      "tags": [],
      "whyItWorks": [
        "Clear, specific title that sets expectations.",
