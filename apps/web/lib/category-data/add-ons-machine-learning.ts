export default {
  ...
  "recommendations": {
    "title": {
      "optimalLength": "24–44 characters (3–6 words)",
      "tips": [
      ...
      "examples": {
        "good": [
          "Google Cloud Vision for Unity",
          "Face Recognition Plugin For Unity",
          "Face Recognition Plugin For Unity",
          "Face Analyzer",
          "Face Analyzer"
        ],
        "bad": [
          "UGPT. Stand-alone implementation of ChatGPT",
          "Grid Framework",
          "ShapeInput ML - User Drawn Shape Input"
        ]
      }
    },
    "description": {
  ...
  "realExamples": [
    ...
    {
      "name": "Google Cloud Vision for Unity",
      "publisher": "PaulArt",
      "tags": [
        "text detection",
        "AI",
    ...
    {
      "name": "Face Recognition Plugin For Unity",
    ...
    {
      "name": "Realeyes Face Verification Plug-in for Unity",
      "publisher": "Realeyes",
      "tags": [
        "AI",
        "Computer Vision",
