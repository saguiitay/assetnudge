export default {
  ...
  "realExamples": [
    ...
    {
      "name": "Order Independent Transparency (OIT)",
      "publisher": "Ciprian Stanciu",
      "tags": [
        "Shader",
        "Effects",
        "Material"
    ...
    {
      "name": "Energy Shield (With impact)",
      "publisher": "Valeron",
      "tags": [],
      "whyItWorks": [
        "Clear, specific title that sets expectations.",
