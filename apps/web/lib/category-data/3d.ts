export default {
  ...
  "recommendations": {
    "title": {
      ...
      "examples": {
        "good": [
          "BasicTown - [MEGA PACK] 300+ Town LowPolyModels",
          "[MEGA PACK] 200+ Tons Furniture LowPoly 3D Models",
          "Low Poly Medieval Fantasy (Cartoon Style)",
          "Orc Base Pack",
          "Low Poly Destructible Cars 2 - Muscle"
        ],
        "bad": [
          "Sci-fi Bunker with PBR texture",
          "Folding Knife",
          "Shuriken pack"
        ]
      }
  ...
  "realExamples": [
    {
      "name": "BasicTown - [MEGA PACK] 300+ Town LowPolyModels",
      "publisher": "NextVertex",
      "tags": [
        "City",
        "town",
        "lowpoly",
    ...
    {
      "name": "[MEGA PACK] 200+ Tons Furniture LowPoly 3D Models",
      "publisher": "NextVertex",
      "tags": [
        "Furniture",
        "lowpoly",
    ...
    {
      "name": "Low Poly Medieval Fantasy (Cartoon Style)",
      "publisher": "Baltasar Sanchez Torregrosa",
      "tags": [
        "bookcase",
        "sword",
        "book",
    ...
    {
      "name": "Low Poly Destructible Cars 2 - Muscle",
      "publisher": "1Poly",
      "tags": [],
      "whyItWorks": [
        "Clear, specific title that sets expectations.",
