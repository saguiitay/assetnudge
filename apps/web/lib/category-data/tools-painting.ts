export default {
  ...
  "recommendations": {
    "title": {
      "optimalLength": "20-26 characters (3-4 words)",
      "tips": [
      ...
      "examples": {
        "good": [
          "Easy Colorize 2D - Sprite Color Modifier",
          "Texture RePainter : Generate variation of the texture",
          "Paint in 2D",
          "Color Studio",
          "Colorize 2D (Sprite Texture Color Modifier)"
        ],
        "bad": [
    ...
    "keywords": {
      "primary": [
        ...
        "webgl much",
        "much more",
        "incredible performance mobile",
        "performance mobile webgl"
      ],
      "secondary": [
        "texture color",
        "color palette",
  ...
  "realExamples": [
    {
      "name": "Easy Colorize 2D - Sprite Color Modifier",
    ...
    {
      "name": "Texture RePainter : Generate variation of the texture",
      "publisher": "Alaa Dev",
      "tags": [
        "pbr textures",
        "brushes",
    ...
    {
      "name": "Colorize 2D (Sprite Texture Color Modifier)",
      "publisher": "Smitesoft",
      "tags": [
        "Painting",
        "2D",
