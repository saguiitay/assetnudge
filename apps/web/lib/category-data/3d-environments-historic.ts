export default {
  ...
  "recommendations": {
    "title": {
      ...
      "examples": {
        "good": [
          "Modular Gladiator Arena (Gladiator Arena, Arena, Colosseum Arena)",
          "Low Poly Church - Optimized & Multi-Pipeline Support",
          "Blacksmith Workshop (URP)",
          "Sunny Hill Village (UModeler X)",
          "Pirate Pack - Synty POLYGON - 477 Assets!"
        ],
        "bad": [
  ...
  "realExamples": [
    {
      "name": "Modular Gladiator Arena (Gladiator Arena, Arena, Colosseum Arena)",
      "publisher": "Hivemind",
      "tags": [
        "historical",
        "Victorian",
    ...
    {
      "name": "Low Poly Church - Optimized & Multi-Pipeline Support",
      "publisher": "MR POLY",
      "tags": [
        "religious",
        "low-poly 3d models",
        "Building",
        "3D Church Model",
        "Optimized Low Poly Building",
        "Game Ready Church Model",
        "Stylized Church 3D",
        "church build",
        "Low Poly Religious Building",
        "Model",
        "optimized 3d model",
        "3D model"
      ],
    ...
    {
      "name": "Sunny Hill Village (UModeler X)",
    ...
    {
      "name": "Pirate Pack - Synty POLYGON - 477 Assets!",
