export default {
  ...
  "realExamples": [
    {
      "name": "Starter Assets - FirstPerson | Updates in new CharacterController package",
    ...
    {
      "name": "Starter Assets - ThirdPerson | Updates in new CharacterController package",
      "publisher": "Unity Technologies",
      "tags": [
        "mobile friendly",
        "standard assets",
    ...
    {
      "name": "Starter Assets: Character Controllers | URP",
      "publisher": "Unity Technologies",
      "tags": [
        "Unity",
        "Character Controller",
